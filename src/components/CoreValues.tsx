  ...
  return (
    <section className={`max-w-[720px] xl:max-w-[1100px] mx-auto w-full mt-8 pb-16 xl:pb-24`}>
      ...
      <div className={`text-center flex flex-col gap-3 py-[16px] px-3`}>
        ...
        <p className={`text-[#636363] leading-[24px] text-[14px] xl:text-[16px] max-w-[420px] w-full mx-auto`}>
          Our values guide how we farm, how we serve, and how we build long-term trust with farmers and communities.
        </p>
      </div>
      
      <div className={`bg-[#F5F5F5] border-white border-[1.5px] font-medium shadow-fancy-two rounded-2xl p-3 grid gap-4  lg:grid-cols-3 my-8`}>
        {data.map((item, index) => (
          <div key={index}
            className={`
