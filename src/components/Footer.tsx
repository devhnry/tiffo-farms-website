export const Footer = () => {
  ...
  return (
    <footer className={`bg-[#F5F5F5] border-white border-[1.5px] shadow-fancy-two rounded-t-2xl p-3 mt-8 max-w-[720px] xl:max-w-[1100px] mx-auto w-full px-6 md:px-20 py-10 flex flex-col gap-8`}>
