export const HeroArea = () => {
  ...
  return (
    <section
      ...
      <div>
        <h1 className={`text-[#1A1A1A] text-[clamp(32px,calc(32px+(70-32)*((100vw-375px)/1065)),70px)] tracking-[0.5px] font-bold leading-[clamp(40px,calc(40px+(78-40)*((100vw-375px)/1065)),78px)] text-center py-4 xl:py-6`}>
          Nourishing Livestock, <br />
          Empowering Farmers
        </h1>
        <p className={`text-[#000500]/80 leading-[24px] text-center text-[14px] xl:text-[16px] max-w-[343px] xl:max-w-[450px] w-full mx-auto`}>Integrated farm and feed-mill, producing nutritious feeds, healthy livestock, and sustainable harvests. With quality at our core and farmers at heart.</p>
      </div>
