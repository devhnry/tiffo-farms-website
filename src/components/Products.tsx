    ...
    <section className="max-w-[1100px] mx-auto w-full pt-8 pb-16 xl:pb-24 px-5">
      ...
      <div className="flex flex-col gap-3 py-4 px-3">
        ...
        <p className="text-[#636363] leading-[24px] text-[14px] xl:text-[16px] max-w-[500px] w-full">
          We produce high-quality protein floating fish feeds in multiple pellet sizes, supporting the cultivation of tilapia, pangasius, and catfish, alongside staple farm products such as plantain and finely processed cassava flour.
        </p>
      </div>
